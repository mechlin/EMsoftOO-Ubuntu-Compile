...
mkdir Release
cd Release
cmake -DEMsoftOO_SDK=/home/mechlin/Build/EMsoftSuperbuildOO/ -DCMAKE_BUILD_TYPE=Release ../
make -j
...
mkdir Release
cd Release
cmake -DCMAKE_BUILD_TYPE=Release -DEMsoftOO_SDK=/home/mechlin/Build/EMsoftSuperbuildOO/ ../../EMsoftOO
make
#cd ../
#mkdir Debug
#cd Debug
